...
def FAKE_train_nnunet(actual_max_num_epochs, 
                 fl_round,
                 val_epoch=True,
                 train_epoch=True,
                 train_cutoff=np.inf,
    ...
    """
    ############## 
    COMENTING OUT ACTUAL TRAINING FOR TEST OF FULL MODEL
                   NETWORK ONLY
    ######################
    class Arguments():
    ...
    this_val_eval_metrics ={'DICE': 0.4}  
    this_val_eval_metrics_C1 = {'DICE': 0.4}
    this_val_eval_metrics_C2 = {'DICE': 0.4}
    this_val_eval_metrics_C3 = {'DICE': 0.4}
    this_val_eval_metrics_C4 = {'DICE': 0.4}
