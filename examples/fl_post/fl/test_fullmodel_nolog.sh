...
# Run nodes
AGG="medperf --platform $AGG_PLATFORM mlcube run --mlcube ./mlcube_agg --task start_aggregator -P 46585"
...
#    a=$(expr $a + 1)
#    medperf --platform docker --gpus=device=1 mlcube run --mlcube ./mlcube_col$a --task train -e MEDPERF_PARTICIPANT_LABEL=col$a@example.com
#done
